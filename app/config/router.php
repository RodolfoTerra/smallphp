<?php
	...
	use \App\Lib\Functions\Native as FunctionsNative;
	...
	class Router
	{
		...
		function __construct ($urlRequest="")
		{
			...
			$arrayRouter = $this->getRouter();
			$this->routerName = $arrayRouter[0];

			if(isset($arrayRouter[1])) { 
				$this->routerConditions = $arrayRouter[1]; 
			}
		...
		public function getModel ()
		{
			...
			/* Dinamic Model */
			$modelVariable = '\App\\Model\\'.$this->routerName;
		...
		public function getView ()
		{
			...
			/* Dinamic View */
			$viewVariable = '\App\\View\\'.$this->routerName;
		...
		public function getControl ()
		{
			...
			/* Dinamic Control */
			$controlVariable = '\App\\Control\\'.$this->routerName;
